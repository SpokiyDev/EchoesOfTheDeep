package com.spokiy.echoesofthedeep.datagen.item;
...
import static com.spokiy.echoesofthedeep.datagen.block.EDBlockStateProvider.name;
...
public class EDItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        blockItem(EDBlocks.SCULK_GUARDIAN);
        blockItem(EDBlocks.CALIBRATED_SCULK_SHRIEKER);
        generated(EDBlocks.SCULK_SPROUTS.getId().getPath(), prefix("item/" + EDBlocks.SCULK_SPROUTS.getId().getPath()));
    ...
    private void blockItem(RegistryObject<Block> block) {
        withExistingParent(name(block.get()), modLoc("block/" + name(block.get())));
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = EchoesOfTheDeep.MOD_ID; // Change this to your mod id
    ...
    public static ResourceLocation prefix(String name) {
        return ResourceLocation.fromNamespaceAndPath(EchoesOfTheDeep.MOD_ID, name.toLowerCase(Locale.ROOT));
    }
