...
public class EDBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<EDSkullBlockEntity>> SKULL =
            BLOCK_ENTITIES.register("skull", () ->
                    BlockEntityType.Builder.of(EDSkullBlockEntity::new,
